const termDescriptionDict: {
    ...
    "ba.elementfragile": {
        ...
        termName: "Elemental Fragility",
        description:
            "Amplifies all Elemental Damage taken by the corresponding amount (only the strongest effect of this type applies)",
    },
    "ba.dying": {
        termId: "ba.dying",
    ...
    "ba.epbarrier": {
        ...
        description:
            "Absorbs a certain amount of <$ba.dt.element>Elemental Injury</>.",
    },
    "ba.tremble": {
        termId: "ba.tremble",
        termName: "Frighten",
        description: "Cannot perform normal attacks when blocked",
    },
    "ba.fear": {
        termId: "ba.fear",
        termName: "Fear",
        description: "Cannot be blocked and runs off uncontrollably",
    },
    "ba.dt.burning2": {
        termId: "ba.dt.burning2",
        termName: "Burn damage - Ally",
        description:
            "Explodes when at max (1000 for Normal and Elite, 2000 for Leaders), dealing 7000 Elemental Damage and temporarily inflicting -20 RES. 10s cooldown.",
    },
    "ba.addash": {
        termId: "ba.addash",
        termName: "Move",
        description:
            "Cannot leave the field, will deploy at the target location with the current HP",
    },
    "ba.magicpoint": {
        termId: "ba.magicpoint",
        termName: "Mana",
        description: "A special form of SP that persists throughout battle",
    },
    "ba.chant": {
        termId: "ba.chant",
        termName: "Chanting",
        description:
            "Stops attacking for a period of time, then attempts to activate skill, interruptions during this period will stop the chant",
    },
    "ba.laiosteam": {
        termId: "ba.laiosteam",
        termName: "Laios's Party",
        description: "Includes Marcille, Senshi, Laios, and Chilchuck",
    },
    "ba.liftoff": {
        termId: "ba.liftoff",
        termName: "Take Off",
        description:
            "Cannot block ground enemies and will not be attacked by them, can block flying enemies",
    },
    "ba.physicfragile": {
        termId: "ba.physicfragile",
        termName: "Physical Fragility",
        description:
    ...
    "cc.bd_B": {
        ...
        description:
            "Affects skills related to <$cc.bd_B_1><@cc.rem>Lingering Melody</></>, <$cc.bd_B_2><@cc.rem>Harmony Astray</></>, and <$cc.bd_B_3><@cc.rem>Wordless Anthem</></>\nProvided by the following Operators' skills:\nEbenholz, Virtuosa, Bassline",
    },
    "cc.bd_C": {
        termId: "cc.bd_C",
    ...
    "cc.bd_dungeon": {
        ...
        termName: "Monster Meal",
        description: "Provided by the following Operators' skills:\nSenshi",
    },
    "cc.m.var1": {
        termId: "cc.m.var1",
        termName: "Recycling",
    ...
    "cc.g.ussg": {
        ...
        description:
            "Includes the following Operators:\nRosa, Zima, Istina, Gummy, Leto",
    },
    "cc.g.A1": {
        termId: "cc.g.A1",
        termName: "A1 Detachment",
        description:
            "Includes the following Operators:\nHibiscus, Lava, Beagle, Fang, Kroos",
    },
    "cc.g.R6": {
        termId: "cc.g.R6",
        termName: "Team Rainbow",
        description:
            "Includes the following Operators:\nAsh Tachanka Blitz Frost Ela Doc Iana Fuze",
    },
    "cc.g.Attack": {
        termId: "cc.g.Attack",
        termName: "Attacking team",
        description: "Includes the following Operators:\nAsh Blitz Iana Fuze",
    },
    "cc.g.Defence": {
        termId: "cc.g.Defence",
        termName: "Defending team",
        description:
            "Includes the following Operators:\nTachanka Frost Ela Doc",
    },
    "cc.g.sp": {
        termId: "cc.g.sp",
        termName: "Alternate",
    ...
    "cc.g.abyssal": {
        ...
        description:
            "Includes the following Operators:\nGladiia, Skadi, Specter, Andreana, Ulpianus",
    },
    "cc.g.psk": {
        termId: "cc.g.psk",
    ...
    "cc.c.room3": {
        ...
        termName: "Workplace",
        description:
            "Includes the following buildings: \nPower Plant, Factory, Trading Post, HR Office, Reception Room, Control Center, Training Room",
    },
    "cc.c.skill": {
        termId: "cc.c.skill",
        termName: "Certain Skills",
        description:
            "Includes the following skills:\nCapable Assistance, S.W.E.E.P., Snack Network, Cleaning Agreement, Substitute, Necessary Responsibility, Guarding, Tiny Leader, Self-Absorbed, Million Dollar Smile, Marigold Poetry Gathering, Art of Defense",
    },
    "cc.t.strong2": {
        termId: "cc.t.strong2",
        termName: "Special Interaction Rules",
    ...
    "cc.c.sui2_1": {
        ...
        description:
            "The highest hourly Morale recovery of <$cc.c.room2><@cc.kw>other buildings</></> provided by <@cc.kw>Business Is Business</>, <@cc.kw>Solitary Light</>, or <@cc.kw>Banner of Babel</> will take effect",
    },
    "cc.m.pow1": {
        termId: "cc.m.pow1",
    ...
    "cc.t.accmuguard1": {
        ...
        termName: "Martial Arts",
        description:
            "Accumulate <@cc.kw>1</> point when assisting with Specialization training to level 1, <@cc.kw>2</> points to level 2, and <@cc.kw>3</> points at level 3, with a maximum accumulation limit of <@cc.kw>3</> points (cannot be accumulated or consumed when the Trainer's Morale is 0)",
    },
    "cc.sk.manu1": {
        termId: "cc.sk.manu1",
    ...
    "cc.tag.op": {
        ...
        description:
            "Includes the following Operators:\nLancet-2, Castle-3, THRM-EX, 'Justice Knight', Friston-3, PhonoR-0",
    },
    "cc.tag.knight": {
    ...
    "cc.tag.durin": {
        ...
        termName: "Durin",
        description:
            "Includes the following Operators:\nMinimalist, Myrtle, Chestnut, Durin, Tecno",
    },
    "cc.tag.mh": {
        termId: "cc.tag.mh",
    ...
    "cc.tag.dungeon": {
        ...
        termName: "Laios's Party",
        description:
            "Includes the following Operators:\nMarcille, Laios, Chilchuck, Senshi",
    },
    "cc.gvial": {
        termId: "cc.gvial",
        termName: "Gavial",
    ...
    "cc.tra.pepe": {
        termId: "cc.tra.pepe",
        termName: "Special Exclusive Order",
        description:
